...
const zh: Record<string, string> = {
  ...
  "library.shorter": "试试更短的关键词。", "library.emptyHint": "新建空白文档，或导入 TXT、Markdown、DOCX、PDF。", "library.blank": "空白文档",
...
const en: Record<string, string> = {
  ...
  "library.shorter": "Try a shorter keyword.", "library.emptyHint": "Create a blank document or import TXT, Markdown, DOCX, or PDF.", "library.blank": "Blank document",
